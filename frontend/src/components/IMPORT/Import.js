    ...
    const setDataFunc = (country1, year1, crop1) => {
            ...
            getDataFunction(country1).then((data) => {
                ...
                for(let i=0;i<yearData.length;i++){
                    let arr = [];
                    let arr2 = [];
                    if(yearData[i].Item+""===crop1 && parseInt(yearData[i].Quantity)!=0){
                        arr.push(country);
                        ...
                        <div className="display-drop">
                            ...
                            <div >
                                ...
                                <Dropdown >
                                    ...
                                    <Dropdown.Menu >
                                        <Dropdown.Item  value="Egypt" onClick={(e)=> {setDataFunc("Egypt", year, crop)}} >Egypt</Dropdown.Item>
                                        <Dropdown.Item  value="Saudi" onClick={(e)=> {setDataFunc("SaudiArabia", year, crop)}}>Saudi Arabia</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            ...
                            <div>
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Menu>
                                        <Dropdown.Item onClick={(e)=> setDataFunc(country, "2019", crop)} value="2019">2019</Dropdown.Item>
                                        <Dropdown.Item onClick={(e)=> setDataFunc(country, "2020", crop)} value="2020">2020</Dropdown.Item>
                            ...
                            <div>
                                ...
                                <Dropdown>
                                    ...
                                    <Dropdown.Menu>
                                        <Dropdown.Item onClick={(e)=> setDataFunc(country, year, "Wheat")} value="Wheat">Wheat</Dropdown.Item>
                                        <Dropdown.Item onClick={(e)=> setDataFunc(country, year, "Rice")} value="Rice">Rice</Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                            </div>                        
